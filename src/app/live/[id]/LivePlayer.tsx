...
import { Eye, Heart, MessageSquare, Send, X, Loader2 } from 'lucide-react';
...
export default function LivePlayer({ id, stream, videoSource, initialViewers, currentUser }: LivePlayerProps) {
